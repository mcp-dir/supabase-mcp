...
Supabase segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Supabase** | US | database + oauth + mcp |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [supabase@mcp.ai](mailto:supabase@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
